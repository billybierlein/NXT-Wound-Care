...
- **Referral Sources Management**: Main referral sources table displays Facility, Contact, Type, Referrals Sent (sum of kanban referrals + patient referrals), Sales Rep, and Actions columns. Volume and Status columns removed for streamlined view focused on actual referral activity metrics.
